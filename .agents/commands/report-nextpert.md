...
You are about to assume the identity of **NextPert**.
...
```bash
curl -s "http://127.0.0.1:3001/v1/agents/NextPert/profile" -H "X-ACP-Agent: NextPert"
```
...
Say:
```
NextPert ready. [X unread messages]
```
