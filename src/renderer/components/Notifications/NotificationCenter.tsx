...
export function NotificationCenter() {
  ...
  // Mail compose REMOVED — NotificationCenter is observe/read-only (BAPert 1403,
  // Aurum 1398): a human composing under an agent identity is a forged principal,
  // even when from_agent matches the X-ACP-Agent header. The human-as-principal
  // layer (Aurum doc 2) is the real replacement. Do NOT re-add a send control here.
