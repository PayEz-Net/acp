...
export function useAcpSse() {
  ...
  // 'connected' is a RE-connect → trigger a full catch-up fetch (messages that
  // arrived while disconnected fired no SSE event). False on first connect
