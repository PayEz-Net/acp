...
- Task 4 chat/terminal polish completed 2026-07-08:
  ...
  - ACP assistant turns render as Markdown (lists, bold, code blocks) instead of raw asterisks; ANSI/control-character leaks are sanitized in the runtime and store.
  - `AgentOutputPanel` hides raw Kimi PTY lines (trash chars / redraw noise) and points users to the ACP transcript in the terminal pane.
