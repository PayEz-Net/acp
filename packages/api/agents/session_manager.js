...
export class SessionManager {
  ...
  _vibeSqlUrl = process.env.VIBESQL_URL || 'http://127.0.0.1:52411';
  _vibeSqlSecret = process.env.VIBESQL_SECRET || '';
