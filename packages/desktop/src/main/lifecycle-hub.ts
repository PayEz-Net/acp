 ...
 * elsewhere in this main-process tree (see signalrClient.ts pattern in
 * the renderer — adapted here for main). Per
...
import { HUB_URL } from './cloud-endpoints';
...
// HUB_URL comes from the single cloud-endpoint authority (cloud-endpoints
// .ts). No `||`, no env-or-dev-93 fallback here: packaged build → prod
// hub, run-from-source → dev-93, decided once, throws if unset. This
