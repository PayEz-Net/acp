#!/usr/bin/env node
/**
 * Workspace-debt guard — additive CI ratchet that makes the E:\Repos /
...
// (DEFAULT_AGENTS E:\Repos literal removed, f9e39f9; no :167 composition
...
if (violations.length) {
  ...
  console.error('\nThe E:\\Repos/scattered-resolver class is banned. One resolver: src/main/pty.ts resolveWorkDir.\n');
  process.exit(1);
}
